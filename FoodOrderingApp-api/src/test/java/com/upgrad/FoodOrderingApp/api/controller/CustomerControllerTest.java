...
public class CustomerControllerTest {
    ...
    public void shouldNotSignUpForEmptyRequest() throws Exception {
        ...
        verify(mockCustomerService, times(0)).registerCustomer(any());
    }
    ...
    public void shouldLogoutForValidRequest() throws Exception {
        ...
        customerEntity.setUuid(customerId);
        createdCustomerAuthEntity.setCustomer(customerEntity);
        when(mockCustomerService.logoutCustomer("access-token")).thenReturn(createdCustomerAuthEntity);
        ...
        mockMvc
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("id").value(customerId));
        verify(mockCustomerService, times(1)).logoutCustomer("access-token");
    }
    ...
    public void shouldNotLogoutWhenCustomerIsNotLoggedIn() throws Exception {
        when(mockCustomerService.logoutCustomer("auth"))
        ...
        verify(mockCustomerService, times(1)).logoutCustomer("auth");
    }
    ...
    public void shouldUpdateCustomerDetails() throws Exception {
        ...
        when(mockCustomerService.getCustomerEntityByAccessToken("auth")).thenReturn(customerEntity);
        ...
        mockMvc
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("id").value(customerId));
        verify(mockCustomerService, times(1)).getCustomerEntityByAccessToken("auth");
    ...
    public void shouldNotUpdateCustomerDetailsIfFirstNameNotPresentInTheRequest() throws Exception {
        ...
        verify(mockCustomerService, times(0)).getCustomerEntityByAccessToken(anyString());
    ...
    public void shouldNotUpdateCustomerDetailsWhenCustomerIsNotLoggedIn() throws Exception {
        when(mockCustomerService.getCustomerEntityByAccessToken("auth"))
                .thenThrow(new AuthorizationFailedException("ATHR-001", "Customer is not Logged in."));
